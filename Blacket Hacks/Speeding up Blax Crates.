...
document.getElementById("blookRarity").style.color = `#fffacd`;
} else if (blookRarity === "Mystical") {
document.getElementById("blookRarity").style.color = `#a335ee`;
} else if (blookRarity === "Divine") {
document.getElementById("blookRarity").style.color = `#ee82ee`;
...
document.getElementById("blookParticles").src = "/images/perfectParticles.gif";
} else if (blookRarity === "Mystical") {
document.getElementById("blookParticles").src = "/images/mysticalParticles.gif";
} else if (blookRarity === "Divine") {
document.getElementById("blookParticles").src = "/images/divineParticles.gif";
}
